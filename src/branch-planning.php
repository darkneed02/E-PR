                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table class="table  mb-0 table-centered" id="datatable_1">
                                        ...
                                        <tbody>
                                            <?php if (!empty($branch_approval)): ?>
                                                <?php foreach ($branch_approval as $index => $row): ?>
                                                    <tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                                        ...
                                        <div class="col-md-12 col-lg-12">
                                            <div class="card">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-bs-toggle="tab" href="#evaluate" role="tab" aria-selected="false">ประเมินค่า</a>
                                                        </li>
                                                        <li class="nav-item">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-block btn-outline-success" data-bs-dismiss="modal" id="approveplanning_Btn">อนุมัติ</button>
