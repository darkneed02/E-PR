...
<body>
    ...
    <?php
        ...
        include 'services/planning/view-planning-table.php';
        // show data view planning
        include 'services/planning/view-planning-data.php';
        // call function view data darft
        $doc_num = $_GET['doc_num'];

        // เรียกฟังก์ชันเพื่อดึงข้อมูล
        view_detail_planing($conn, $doc_num);
        $view_table_planning = getPlanningData_doc_num($conn, $doc_num);
    ?>
                            ...
                            <div class="card-header">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col text-end">
                                        <button type="button" class="btn btn-block  btn-success" id="btn_requst_darft_approve"><i class="far fa-check-circle"></i>
                                        ...
                                        <button type="button" class="btn btn-block btn-danger" id="btn_cancel_planning"><i class="las la-times-circle"></i></i>
                                             <span class="fw-bold">ยกเลิกแผน</span>
                                        </button>
                                    </div><!--end col-->
                                </div> <!--end row-->
                            </div><!--end card-header-->
                                ...
                                <div class="row g-2">
                                    <div class="col-md-4">
                                        <label class="mb-2">เอกสาร</label>
                                         <input type="text" class="form-control" name="doc_num" id="doc_num" value="<?php echo $doc_num; ?>"  readonly>
                                    </div><!-- end col -->
                                    <div class="col-md-4">
                                        <label class="mb-2">ประเภทเอกสาร</label>
                                        <?php
                                        // สมมติว่าคุณได้รับค่าจากฐานข้อมูล
                                        $type_select = $type_doc; // ตัวอย่างค่าที่ได้จากฐานข้อมูล
                                        ?>
                                        <select id="default" name="type_doc">
                                            <!-- ตัวเลือกแบบ static -->
                                            <option value="PR01" <?= $type_select === "PR01" ? "selected" : ""; ?>>ใบขอเสนอซื้อ</option>
                                            <option value="PR03" <?= $type_select === "PR03" ? "selected" : ""; ?>>ใบขอเสนอจ้าง</option>
                                            <option value="PR02" <?= $type_select === "PR02" ? "selected" : ""; ?>>ใบขอเสนอเช่า</option>
                                        </select>
                                    </div> <!-- end col -->
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group" id="DateRange">
                                            ...
                                            <input type="date" class="form-control" name="start_date" id="start_date" placeholder="Start" aria-label="StartDate" value="<?php echo $date_start; ?>">
                                            <span class="input-group-text">ถึง</span>
                                            <input type="date" class="form-control rounded-end" name="end_date" id="end_date" placeholder="End" aria-label="EndDate" value="<?php echo $end_date; ?>">
                                        </div>
                                    </div><!-- end col -->
                                    <hr> 
                                    <div class="col-md-6">
                                        <label class="mb-2">บันทึกส่วนหัว</label> 
                                        <input type="text" class="form-control" name="header" id="header" value="<?php echo $header; ?>"  max="80">
                                    </div><!-- end col -->
                                    <div class="col-md-6">
                                        <label class="mb-2">คำอธิบาย</label>
                                        <textarea name="deatil" id="deatil" class="form-control"><?php echo $detail; ?></textarea>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!--end card-body-->
                        </div><!--end card-->
                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table id="list_order" class="table table-bordered text-center">
                                        ...
                                        <tbody>
                                            <?php if (!empty($view_table_planning)): ?>
                                                        <?php foreach ($view_table_planning as $index => $row): ?>
                                                            <tr>
                                                                <td><input class="form-check-input delete-checkbox" type="checkbox"></td>
                                                                <td><?php echo htmlspecialchars($row['order_list']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['group_account']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['matrail_name']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['short_meagess']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['quantity']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['unit']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['delivery_date']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['requst_date']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['mm_group']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['factory_mm']); ?></td>
                                                                <td><?php echo htmlspecialchars($row['product_storage']); ?></td>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select id="default_g_l" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($view_g_l as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['g_l_name']); ?>">
                                                                    <?php echo htmlspecialchars($data['g_l_name']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select id="default_fun_center" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($cost_center as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['cost_name']); ?>">
                                                                    <?php echo htmlspecialchars($data['cost_name']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="default_spoce" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($view_scope as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['scope_name']); ?>">
                                                                    <?php echo htmlspecialchars($data['scope_name']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="default_messsinons" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($commitment as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['short_text']); ?>">
                                                                    <?php echo htmlspecialchars($data['short_text']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="default_money_center" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($fund as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['fund_name']); ?>">
                                                                    <?php echo htmlspecialchars($data['fund_name']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select id="default_funds_center" class="form-control" name="type_doc">
                                                            ...
                                                            <?php foreach ($s_fund as $data): ?>
                                                                <option value="<?php echo htmlspecialchars($data['name_s_ct']); ?>">
                                                                    <?php echo htmlspecialchars($data['name_s_ct']); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
    ...
    <script src="assets/js/planning-pr/update-planning.js"></script><!-- บันทึกแผน และ บันทึกแผนร่าง -->
