                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table class="table  mb-0 table-centered" id="datatable_1">
                                        ...
                                        <tbody>
                                            <?php if (!empty($province_approval)): ?>
                                                <?php foreach ($province_approval as $index => $row): ?>
                                                    <tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-block btn-outline-success" data-bs-dismiss="modal" id="btn_approval_provinces">อนุมัติ</button>
