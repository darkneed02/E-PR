    ...
    swal
      ...
      .then((result) => {
        if (result.isConfirmed) {
          console.log("ผู้ใช้ยืนยัน: เริ่มต้นแสดง Loading");
          ...
          // จำลองการส่งข้อมูล AJAX พร้อมหน่วงเวลา
          setTimeout(() => {
            $.ajax({
              ...
              error: function () {
                console.log("AJAX Error: เกิดข้อผิดพลาดในการส่งข้อมูล");
                swal.fire({
                  icon: "error",
          ...
          console.log("ผู้ใช้ยกเลิกการดำเนินการ");
          swal.fire({
            icon: "info",
