new Selectr("#default"),
  new Selectr("#default_g_l"),
  new Selectr("#default_fun_center"),
  new Selectr("#default_spoce"),
  new Selectr("#default_messsinons"),
  new Selectr("#default_money_center"),
  new Selectr("#default_funds_center"),
